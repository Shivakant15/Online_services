...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">Shiva services</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/DSC02229.JPG);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to Shiva services</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">Shiva Services</h3>
      <p>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">The site is very good and we can resolve our issue very easly from here.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">very fast and fine and we can resolve our issue very easly from here.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">very much reliable and i will give 10/10 and i will also say that you can use the site with your close eyes.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">simply i will rate it 100% on the besis on my experience and everybody should try.</p>
            </div>
          </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        OSMS Pvt Ltd, <br>
        Ariyauna,Akbarpur <br>
        Ambedkarnagar,UP - 224122 <br>
        Phone: +91 8299027690 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>

        <br><br>
        <strong>Allahabad Branch:</strong> <br>
        OSMS Pvt Ltd, <br>
        Jhalwa, Allahabd <br>
        Allahabd - 211012 <br>
        Phone: +91 8299027690 <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6">
          ...
          <a href="https://www.facebook.com/shivakant.upadhyay.92" target="_blank" class="pr-2 fi-color"><i class="fab fa-facebook-f"></i></a>
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Shivakant_upadhyay &copy; 2019.
          </small>
